...
func main() {
	fmt.Println(base64.StdEncoding.EncodeToString(AesEncrypt("123456", "12345678901234567890123456789012")))
	fmt.Println("--------")
	enc, _ := base64.StdEncoding.DecodeString("14bEvA7CeyIoopYkYqtNWw==")
	fmt.Println(string(AesDecrypt(enc, []byte("12345678901234567890123456789012")))
